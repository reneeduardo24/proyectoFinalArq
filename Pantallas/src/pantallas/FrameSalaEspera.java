 ...
 * @author rene_
 */
public class FrameSalaEspera extends javax.swing.JDialog implements IObservador{

    private static FrameSalaEspera pantallaSalaDeEspera;
     ...
     */
    public FrameSalaEspera(java.awt.Frame parent, boolean modal, 
     ...
     * @return
     */
    public static FrameSalaEspera getInstacia(Frame parent, boolean modal,
        ...
        if (pantallaSalaDeEspera == null) {
            pantallaSalaDeEspera = new FrameSalaEspera(parent, modal, jugador, listaJugadores, capacidadDePartida,facadaDeControl);
        } else {
        ...
        try {
            ...
            Logger.getLogger(FrameSalaEspera.class.getName()).log(Level.SEVERE, null, ex);
        }
